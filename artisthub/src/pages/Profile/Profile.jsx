...
//NO TOCAR ESTE CÓDIGO, ES DE RESERVA.
// const Profile = () => {
...
//           const userPublications = await getUserPublications(token, profileData._id);
...
//                       initialLikes={publication.likes.length}
//                       comments={publication.comments.length}
//                       shares={publication.shares.length}
//                       favorites={publication.favorites.length}
//                     />
//                   ))}
//                 </div>
//               </div>
