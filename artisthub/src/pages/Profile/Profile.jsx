...
import { getMyProfile, updateUserProfile, createNewPublication } from '../../services/apiCalls.js'; 
...
//                   Edit Profile
//                 </button>
//                 <button onClick={() => history.push('/create-publication')} className="bg-green-500 text-white px-4 py-2 rounded ml-2">
//                   Create Publication
//                 </button>
//               </div>
//             </>
