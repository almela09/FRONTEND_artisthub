...
const Banner = () => {
  ...
  return (
    <div className="sliderAx h-auto">
      <div
        className={`container mx-auto ${currentSlide === 0 ? "" : "hidden"}`}
      >
        <div
        ...
        >
          <div className="md:w-1/2">
            ...
            <p className="text-3xl font-bold">
              Welcome to our great art community
            </p>
      ...
      <div
        className={`container mx-auto ${currentSlide === 1 ? "" : "hidden"}`}
      >
        <div
          className="bg-cover bg-top h-auto text-white py-24 px-10 object-fill"
          style={{ backgroundImage: `url(${pueblo})` }}
        >
      ...
      <div className="flex justify-between w-12 mx-auto pb-2">
        <button
          ...
          className={`rounded-full w-4 p-2 ${
            currentSlide === 0 ? "bg-purple-800" : "bg-purple-400"
          }`}
        />
        <button
          id="sButton2"
          ...
          className={`rounded-full w-4 p-2 ${
            currentSlide === 1 ? "bg-purple-800" : "bg-purple-400"
          }`}
        />
      </div>
    </div>
