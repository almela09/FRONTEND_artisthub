...
const CreatePublication = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        setLoading(false);
        navigate('/profile'); // Redirige a la página de perfil después de crear la publicación
      } catch (error) {
          ...
          {loading ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-5 text-center">
                ...
                <button type="button" onClick={() => navigate('/profile')} className="bg-gray-500 text-white px-4 py-2 rounded ml-2">
                  Cancel
                </button>
              </div>
            </form>
